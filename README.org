...
- *Optional top-level overline* — adds an overline to level-1 headings for visual section breaks, via ~outline-stars-level-1-overline~
...
- *Section numbering* — insert or update hierarchical section numbers (1, 1.1, 1.1.2) across all headings, with a separate command to strip them
...
| ~outline-stars-number-headings~   | Insert or update section numbers (1, 1.1, 1.1.2)     |
...
| ~outline-stars-level-1-overline~  | ~nil~         | Add an overline to top-level headings               |
